...
compose-buildjvm:
	...
	cp -pR $(OUTPUT_ROOT)/vm/*.so $(JDK_OUTPUTDIR)/lib/compressedrefs/
	cp -p $(OUTPUT_ROOT)/vm/J9TraceFormat.dat $(JDK_OUTPUTDIR)/lib/
	cp -p $(OUTPUT_ROOT)/vm/OMRTraceFormat.dat $(JDK_OUTPUTDIR)/lib/
	cp -pR $(OUTPUT_ROOT)/vm/options.default $(JDK_OUTPUTDIR)/lib/
	cp -pR $(OUTPUT_ROOT)/vm/java*properties $(JDK_OUTPUTDIR)/lib/
...
compose:
	...
	cp -pR $(OUTPUT_ROOT)/vm/*.so $(IMAGES_OUTPUTDIR)/jdk/lib/compressedrefs/
	...
	cp -pR $(OUTPUT_ROOT)/vm/options.default $(IMAGES_OUTPUTDIR)/jdk/lib/
	cp -pR $(OUTPUT_ROOT)/vm/java*properties $(IMAGES_OUTPUTDIR)/jdk/lib/
